    ...
    if ($result->isSuccess()) {
        ...
        return [
            ...
            'analysis' => [
                ...
                'introduction_summary' => $finalAnalysis['introduction_summary'] ?? null,
                'subtitle_ko' => $finalAnalysis['subtitle_ko'] ?? null,
                'original_subtitle' => $finalAnalysis['original_subtitle'] ?? null,
