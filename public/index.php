...
// 1) 쿼리 __api_path (호스팅 호환) 2) REDIRECT_* (Apache)
$originalUri = $_GET['__api_path'] ?? $_SERVER['REDIRECT_ORIGINAL_URI'] ?? $_SERVER['REDIRECT_URL'] ?? null;
if ($originalUri !== null && $originalUri !== '' && str_starts_with((string) $originalUri, '/api/')) {
