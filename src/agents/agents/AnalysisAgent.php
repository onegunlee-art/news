...

{
  ...
  "content_summary": "가독성 좋은 구조화 형식.\n\n한글 제목 (영문 제목)\n\n[논리적 섹션별 요약]. 소제목이 있으면 번호 붙여 사용, 없으면 도입·전개·데이터·결론으로 구분. 각 단락은 짧게 끊고, 단락 사이 빈 줄을 넣어 화면에서 읽기 쉽게 작성. 최소 600자 이상.",
  "key_points": [
...

{
  ...
  "content_summary": "구조화 형식.\n\n한글 제목 (영문 제목)\n\n1. 소제목1 한글 (영문)\n[섹션 요약]\n\n2. 소제목2 한글 (영문)\n[섹션 요약]\n\n각 섹션은 짧은 문단으로 나누고, 섹션 사이 빈 줄을 유지해 가독성을 확보하세요. 최소 600자 이상.",
  "key_points": [
