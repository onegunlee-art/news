...
PROMPT;
    ...
    private function buildNarrationFromAnalysisPrompt(ArticleData $article, array $analysisData): string
    {
        ...
        return <<<PROMPT
[필수 출력 형식 - 반드시 준수]
JSON으로만 응답하세요. "narration" 필드를 사용하지 마세요.
반드시 "narration_paragraphs" 배열을 사용하세요. 각 원소가 하나의 문단입니다.
...
- 핵심 논지, 배경, 중요한 근거, 의미를 자연스럽게 설명하세요.
- 첫 문장은 바로 핵심으로 시작. 인사말 금지.
- 기사에 없는 주장이나 과도한 확신 금지.
- key_points를 기계적으로 나열하지 말고 흐름 있는 설명문으로 작성.
...
위 기사 원문과 1차 분석 결과를 참고하여 The Gist 스타일의 narration을 작성하세요.
