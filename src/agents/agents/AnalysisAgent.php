...
HINT;
            ...
            $domainHint = <<<HINT
[The Economist 기사 — 압축 분석 모드]
- Economist 기사는 소제목이 없으므로, 전체 논지를 기준으로 **핵심 논점 3~4개**를 추출하세요.
- section_analysis는 **최소 3개, 최대 4개**로 제한하세요. 5개 이상 금지.
- 단락(paragraph)을 개별 섹션으로 만들지 마세요. 3~5개 단락을 하나의 논점으로 **공격적으로 병합**하세요.
- summary는 **1~2문장(40~80자)** 으로 핵심만 남기세요. 원문의 문장을 그대로 옮기지 마세요.
- 원문 대비 **50% 이하 분량**으로 압축하세요. 번역이 아니라 요약입니다.
- 구독 유도 문구, 날짜, UI 요소는 무시하세요.

[Economist 압축 원칙]
1. 단락별 번역 ✕ → 논점별 재구성 ○
2. 구체적 수치는 key_points에 집중, summary는 흐름만
3. 유사한 주장·근거는 하나의 섹션으로 통합

[Economist 예시 - 반드시 이 압축 수준을 따르세요]
<example>
기사: "How India Can Supercharge Its Development"

출력:
{
  "news_title": "인도, CPTPP로 중진국 함정 탈출할 수 있을까",
  "author": "",
  "original_title": "How India Can Supercharge Its Development",
  "introduction_summary": "미국의 변덕, 중국의 압박 속에서 인도는 CPTPP 가입으로 개혁·성장·규칙 기반 질서를 동시에 확보할 수 있다.",
  "section_analysis": [
    {
      "section_title": "UNFAVORABLE CONDITIONS",
      "section_title_ko": "불리한 조건",
      "summary": "인도는 미·중 갈등과 경제 민족주의 속에서 미국 의존을 줄이고 EU·일본·동남아로 파트너를 다변화하고 있다.",
      "key_insight": "미국 의존 축소와 다변화 파트너십이 인도의 새로운 전략 방향이다."
    },
    {
      "section_title": "CPTPP AS REFORM ENGINE",
      "section_title_ko": "개혁 엔진으로서의 CPTPP",
      "summary": "CPTPP의 높은 기준(노동·지재권·국영기업 규율)은 가입 자체가 구조개혁을 강제하는 장치로, 인도에 연 560억 달러 GDP 효과가 추정된다.",
      "key_insight": "CPTPP 가입은 관세 인하를 넘어 국내 구조개혁의 외부 강제력이 된다."
    },
    {
      "section_title": "OBSTACLES AND PATHWAY",
      "section_title_ko": "장애물과 돌파구",
      "summary": "농업 개방, 국영기업 규율 등 정치적 난관이 크고 RCEP 철수 전례로 신뢰 문제가 남아 있어 단계적 접근이 필요하다.",
      "key_insight": "덜 민감한 분야(디지털·AI)부터 신뢰를 쌓은 뒤 핵심 분야로 확대하는 전략이 현실적이다."
    },
    {
      "section_title": "GEOPOLITICAL WINDOW",
      "section_title_ko": "지정학적 기회의 창",
      "summary": "인도가 합류하면 미·중 어느 쪽도 지배하지 않는 개방경제 블록이 확장되며, 트럼프 관세 충격이 오히려 개혁의 추동력이 될 수 있다.",
      "key_insight": "지금이 어려운 개혁을 밀어붙일 정치적·지정학적 창이다."
    }
  ],
  "key_points": [
    "트럼프 행정부 고율 관세로 인도의 통상 다변화 가속",
    "CPTPP 12개 회원국, 세계 경제 약 15%, 연 5,000억 달러 교역 포괄",
    "인도 CPTPP 가입 시 연 560억 달러 GDP 증가 효과 추정",
    "2019년 RCEP 철수 전례로 신뢰 문제 잔존"
  ],
  "geopolitical_implication": "인도의 CPTPP 가입은 미·중 양극 체제를 넘어서는 다극적 경제 질서를 만들어, 한국 포함 역내 국가들의 통상 환경을 재편할 수 있다."
}
</example>

[Economist 예시에서 배울 점]
- section_analysis: **최대 4개** — 논점 단위로 공격적 병합
- summary: **1~2문장, 40~80자** — 원문 번역이 아닌 핵심 압축
- key_insight: 한 줄로 핵심 인사이트
- key_points: 구체적 수치/사실 집중
- 전체 분석이 원문의 **50% 이하**
