...

{
  ...
  "narration": "독자를 위한 내레이션. 인사말 없이 바로 본문으로 시작. 도입에서 무슨 일이 있었는지 간단히 한 뒤, 논리적 흐름(도입·전개·데이터·결론)에 맞춰 자연스럽게 이어가며, 각 섹션의 핵심 수치와 배경을 2~4문장으로 풀어서 설명. 번호나 소제목 형식(1. 2. 등)은 쓰지 말고, 말하듯이 자연스러운 문장만 사용. 귀로만 들어도 기사 전체를 이해할 수 있도록 충분히 상세하게. 최소 1000자 이상."
}
PROMPT;
    }
...

{
  ...
  "narration": "독자를 위한 내레이션. 인사말 없이 바로 본문으로 시작. 도입에서 무슨 일이 있었는지 간단히 (2~3문장) 한 뒤, 원문의 섹션별 핵심 내용을 자연스러운 문장 흐름으로 이어가며, 각 섹션의 핵심 논지와 근거를 2~4문장으로 풀어서 설명. 번호나 소제목 형식(1. 2. 등)은 쓰지 말고 말하듯이만 작성. 섹션 전환 시 '반면,', '이런 시각에서', '따라서' 등 연결어 사용. 귀로만 들어도 기사 전체를 이해할 수 있도록 충분히 상세하게. 최소 1000자 이상."
}
PROMPT;
    }
