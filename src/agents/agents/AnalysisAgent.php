...

{
  ...
  "sections": [
    {
      "original_heading": "소제목 (있으면). FT는 소제목이 적을 수 있으므로 없으면 빈 배열.",
      "translated_heading": "한글 번역",
      "summary": "해당 섹션 요약 (2~4문장)"
    }
  ],
  "content_summary": "가독성 좋은 구조화 형식.\n\n한글 제목 (영문 제목)\n\n[논리적 섹션별 요약]. 소제목이 있으면 번호 붙여 사용, 없으면 도입·전개·데이터·결론으로 구분. 최소 600자 이상.",
  "key_points": [
  ...
  "narration": "독자를 위한 내레이션. 인사말 없이 바로 본문으로 시작.\n\n[구조]\n- 도입: 무슨 일이 있었는지 간단히\n- 본문: 논리적 흐름(도입·전개·데이터·결론)에 따라 섹션 전환을 명확히. 예: '자, 그러면 데이터를 보시죠.' 처럼 전환 표현 사용\n- 각 섹션: 핵심 수치와 배경을 2~4문장으로 풀어서 설명\n\n귀로만 들어도 기사 전체를 이해할 수 있도록 충분히 상세하게. 최소 1000자 이상."
}
PROMPT;
    }
...

{
  ...
  "sections": [
    {
      "original_heading": "원문 소제목 (ALL CAPS 헤딩). 소제목이 없으면 빈 배열.",
      "translated_heading": "한글 번역",
      "summary": "해당 섹션 요약 (2~4문장)"
    }
  ],
  "content_summary": "구조화 형식.\n\n한글 제목 (영문 제목)\n\n1. 소제목1 한글 (영문)\n[섹션 요약]\n\n2. 소제목2 한글 (영문)\n[섹션 요약]\n\n최소 600자 이상.",
  "key_points": [
  ...
  "narration": "독자를 위한 내레이션. 인사말 없이 바로 본문으로 시작.\n\n[구조]\n- 도입: 무슨 일이 있었는지 간단히 (2~3문장)\n- 본문: 원문의 섹션별 핵심 내용을 '번호 + 소제목' 형식으로 명확히 구분.\n  예시: '1. 정착하지 말 것 (DON'T SETTLE)\\n동맹은 반도체·핵심 광물 등 공급망 다변화와...'\n- 각 섹션: 해당 섹션의 핵심 논지와 근거를 2~4문장으로 풀어서 설명\n- 섹션 전환 시 '반면,', '이런 시각에서', '따라서' 등 명확한 연결어 사용\n\n귀로만 들어도 기사 전체를 이해할 수 있도록 충분히 상세하게. 최소 1000자 이상. (일부만 분석된 경우 끝에 [기사 일부만 분석됨] 표시)"
}
PROMPT;
    }
...

{
  ...
  "sections": [
    {
      "original_heading": "원문 소제목 (ALL CAPS 또는 볼드 헤딩). 예: DON'T SETTLE. 소제목이 없으면 빈 배열로.",
      "translated_heading": "한글 번역. 예: 정착하지 말 것",
      "summary": "해당 섹션의 핵심 내용 요약 (2~4문장)"
    }
  ],
  "content_summary": "줄글이 아닌 가독성 좋은 구조화 형식으로 작성.\n\n한글 제목 (영문 제목)\n한글 부제 (영문 부제)\n\n[전체 요약 - 영문 1줄 → 한글 1줄 교차]\n\n1. 소제목1 한글 (영문)\n[해당 섹션 요약]\n\n2. 소제목2 한글 (영문)\n[해당 섹션 요약]\n\n- 번호 붙인 소제목 형식 사용\n- 소제목이 없으면 전체 요약만 작성\n- 최소 600자 이상",
  "key_points": [
