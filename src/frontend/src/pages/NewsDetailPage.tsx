    ...
    <div className="min-h-screen bg-white pb-20 md:pb-8">
      ...
      >
        ...
        <div className="px-4 pt-5 pb-8">
          ...
          {/* 디폴트 출처 문구: 기사 제목은 모조건 영어(original_title 우선, URL슬러그 추출). 한국어 title 폴백 금지 */}
          <p className="text-sm text-gray-500 mb-6">
            이 글은 {formatDate() ? `${formatDate()}자, ` : ''}{((news.original_source && news.original_source.trim()) || news.source || 'The Gist')}에 게재된 &quot;{(news.original_title && news.original_title.trim()) || extractTitleFromUrl(news.url) || '[영문 원제목을 Admin에서 입력해주세요]'}&quot; 기사를 The Gist가 AI를 통해 분석/정리한 것 입니다.
          </p>
