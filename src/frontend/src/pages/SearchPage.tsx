      ...
      <div className="flex flex-col justify-between py-1" role="group" aria-label="기사 액션">
        ...
        >
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15.536 8.464a5 5 0 010 7.072M18.364 5.636a9 9 0 010 12.728M12 18.75a.75.75 0 01-.75-.75V6a.75.75 0 011.5 0v12a.75.75 0 01-.75.75z" />
          </svg>
        </button>
        <button type="button" onClick={handleShare} className="p-1 text-gray-300 hover:text-yellow-500 transition-colors" title="카카오톡 공유">
