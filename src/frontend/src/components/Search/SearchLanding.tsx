...
export default function SearchLanding({
  ...
  return (
    ...
    >
      <div
        className="flex w-full flex-col items-center px-4 max-md:flex-none max-md:justify-start max-md:pt-4 max-md:pb-2 md:flex-1 md:justify-center md:py-8 md:min-h-[40vh]"
      >
