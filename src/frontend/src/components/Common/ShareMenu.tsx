  ...
  return (
    <div className="relative inline-block" ref={menuRef}>
      <button
        ...
        aria-haspopup="true"
      >
        <ShareIcon className="w-5 h-5" strokeWidth={1.5} aria-hidden />
      </button>
      ...
      {open && (
        ...
        >
          ...
          >
            <ClipboardDocumentIcon className="w-4 h-4 text-gray-500" strokeWidth={2} />
            링크 복사
          </button>
          {typeof navigator !== 'undefined' && 'share' in navigator && typeof navigator.share === 'function' && (
            <button
              ...
              className="w-full px-3 py-2 text-left text-sm text-gray-700 hover:bg-gray-50 flex items-center gap-2"
            >
              <ShareIcon className="w-4 h-4 text-gray-500" strokeWidth={2} />
              더 많은 앱으로 공유
            </button>
          )}
        </div>
