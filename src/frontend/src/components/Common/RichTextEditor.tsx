...
export default function RichTextEditor({
  ...
  return (
    <div className={`flex flex-col min-w-0 overflow-x-hidden ${noMaxHeight ? '' : 'overflow-y-auto max-h-[60vh]'}`}>
