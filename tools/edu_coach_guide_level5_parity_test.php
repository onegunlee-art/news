...
assertTrue('L3 path uses v1 (numeric 3)', eduCoachLevelCoachPath(EDU_COACH_LEVEL_L3) === 'l3');
...
assertSame('L3 (legacy middle) matches L5 v1 intro', $level3Open['message'], $level5Open['message']);
