...
6. 답변 구조 (반드시 따를 것):
   모든 답변은 아래 구조를 따르세요. 각 섹션 앞에 라벨을 붙이세요.
   가. [핵심] 한 줄로 결론을 먼저 말하세요.
   나. [분석] 2~3개 핵심 포인트로 근거를 제시하세요.
   다. [연결] RAG 보조 맥락에 관련 기사(제목 포함)가 있으면 반드시 언급하세요. "the gist.에서 다룬 관련 콘텐츠: (제목)" 형태로 안내하세요. 관련 기사가 없으면 이 섹션을 생략하세요.
   라. [유의] 답변의 한계나 불확실한 부분이 있으면 짧게 명시하세요. 없으면 생략하세요.
PROMPT,
